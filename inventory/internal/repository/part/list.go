...
func (r *repository) ListParts(_ context.Context, filter model.PartsFilter) ([]model.Part, error) {
	...
	// Конвертируем filterModel и создаем список
